...
tree = ttk.Treeview(win, column=("Employee Number", "Name", "Month", "No. of Days", "No. of Leaves", "Overtime(in hrs.)", "Salary", "Salary/day",
...
try:
    ...
    for row in results:
        ...
        tree.insert('', 'end', text="1",
                    values=(empno, name, month, ndays, nleaves, otime, salary, spday, deduct, etime, gpay))
except:
    print("ERROR")
a.close()
conn.close()
